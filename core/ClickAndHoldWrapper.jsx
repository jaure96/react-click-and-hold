...
const ClickAndHold = ({ id, elmType = 'div', timeOut = 500, onClick = () => { }, onHold = () => { }, children, }) => {
    ...
    return React.createElement(elmType, { onPointerDown, onPointerUp, onPointerMove }, children)
}
